...
@Component({
  selector: 'app-maestria-finanzas',
  templateUrl: './maestria-finanzas.component.html',
  styleUrls: ['./maestria-finanzas.component.css']
})
export class MaestriaFinanzasComponent implements OnInit {
  ...
  constructor(public dialog: MatDialog, private titleService: Title) {
    this.listVideos = [
      {iframe: "https://www.youtube.com/embed/bXT7G3R_qo4", img: "http://i3.ytimg.com/vi/v6RB-jabufw/hqdefault.jpg"}
    ]

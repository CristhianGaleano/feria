...
@Component({
  selector: 'app-especializacion-ciberasesoria-financiera',
  templateUrl: './especializacion-ciberasesoria-financiera.component.html',
  styleUrls: ['./especializacion-ciberasesoria-financiera.component.css']
})
export class EspecializacionCiberasesoriaFinancieraComponent implements OnInit {
  ...
  ngOnInit() {
    this.titleService.setTitle("Especialización Ciberasesoría Financiera - Expo Virtual - UCP");
  }

...
@Component({
  selector: 'app-maestria-gestion-regional',
  templateUrl: './maestria-gestion-regional.component.html',
  styleUrls: ['./maestria-gestion-regional.component.css']
})
export class MaestriaGestionRegionalComponent implements OnInit {

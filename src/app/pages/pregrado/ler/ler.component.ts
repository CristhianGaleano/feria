...
export class LerComponent implements OnInit {
  ...
  constructor(public dialog: MatDialog, private titleService: Title) {
    this.listVideos = [
      {iframe: "https://www.youtube.com/embed/m1DF4CRWPmk", img: "http://i3.ytimg.com/vi/EzibMUCt4Ik/hqdefault.jpg"}
    ]
  ...
  ngOnInit() {
    this.titleService.setTitle("Licenciatura en Educación Religiosa Expo Virtual - UCP");
  }
